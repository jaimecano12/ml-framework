...
\centering
\vspace*{1.5cm}
{\Large\bfseries UNIVERSIDAD POLIT\'ECNICA DE MADRID\\[0.4em]
ESCUELA T\'ECNICA SUPERIOR\\DE INGENIEROS DE TELECOMUNICACI\'ON}
\vspace{1.5cm}

\rule{\textwidth}{1.5pt}\\[0.3em]
{\large M\'ASTER UNIVERSITARIO EN INGENIER\'IA DE TELECOMUNICACI\'ON}\\[0.3em]
{\large TRABAJO FIN DE M\'ASTER}\\
\rule{\textwidth}{1.5pt}

\vspace{1.5cm}
{\LARGE\bfseries An Automated Framework for Dataset Quality\\[0.3em]
Assessment and Data Leakage Detection\\[0.3em]
in Machine Learning}

\vspace{2cm}
{\large\bfseries JAIME CANO MORA\~{N}O}\\[0.5em]
{\normalsize Madríd, 2025--2026}
...
\begin{center}
\vspace*{2cm}
{\Large\bfseries TRABAJO FIN DE M\'ASTER}\\[1.5em]
\begin{tabular}{ll}
\textbf{T\'itulo:} & \parbox[t]{0.72\linewidth}{An automated framework for dataset quality
  assessment and data leakage detection in machine learning}\\[1em]
...
\vspace{1.5cm}
{\large\bfseries MIEMBROS DEL TRIBUNAL}\\[0.5em]
\begin{tabular}{ll}
Presidente: & D.\ \dotfill\\[0.4em]
Vocal:      & D.\ \dotfill\\[0.4em]
Secretario: & D.\ \dotfill\\[0.4em]
Suplente:   & D.\ \dotfill\\
\end{tabular}

\vspace{1cm}
Los miembros del tribunal arriba nombrados acuerdan otorgar la calificación de: \dotfill

\vspace{0.5cm}
Madrid, a \quad de \quad de 20\ldots
\end{center}
\clearpage
